  ...
  const routes = [
    {
      ...
      path: '/config/user',
      models: () => [import('./models/config/user')],
      component: () => import('./routes/config/user/'),
    },{
      path: '/device',
      models: () => [import('./models/device')],
      component: () => import('./routes/device/'),
    },{
      path: '/fishyu',
      models: () => [import('./models/fishyu')],
      component: () => import('./routes/fishyu/'),
    }
